...
def p_errorleer2(prod):
    '''
    leer : read  ASSIGN error FIN_LINEA
    '''
    agregarError(11.1,'Sintactico','Error en la asignacion falto :',prod[4], prod.lineno(4)+1, obtenerColumna(prod.lexer.lexdata, prod, 4))
def p_errorleer3(prod):
    '''
    leer : read TWPOINT  error FIN_LINEA
    '''
    agregarError(11.2,'Sintactico','Error en la asignacion falto =',prod[4], prod.lineno(4)+1, obtenerColumna(prod.lexer.lexdata, prod, 4))
